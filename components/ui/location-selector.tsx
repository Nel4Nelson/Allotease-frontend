        ...
        try {
          ...
          if (data.features && data.features.length > 0) {
            ...
            const location: LocationData = {
              ...
              country: context.find((c: any) => c.id.includes('country'))?.text || 'Nigeria'
            };
          ...
          <div className="w-full max-w-[565px] h-[198px] rounded-[24px] bg-[#D9D9D9] border border-gray-200 flex flex-col items-center justify-center text-center p-8">
            <div className="w-16 h-16 bg-(--body-text) rounded-full flex items-center justify-center mb-4">
              <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9v-3a5 5 0 00-5-5 5 5 0 00-5 5v3m0 0h10" />
              </svg>
            </div>
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Online Event</h3>
