...
interface UnverifiedStayModalProps {
  isOpen: boolean;
  onClose: () => void;
  onProceed: () => void;
  stayTitle: string;
...
export function UnverifiedStayModal({
  isOpen,
  onClose,
  onProceed,
  stayTitle,
  className = "",
}: UnverifiedStayModalProps) {
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center space-y-6 py-8">
          ...
          <div className="space-y-3">
            ...
            >
              This accommodation is listed by an allocation admin who has not yet been
              verified by Allotease. Please exercise caution when making reservations.
            </p>
            <p
              style={{
                color: "#7A7A7A",
            ...
            >
              We recommend verifying all details directly with the property owner
              before proceeding with any booking or payment.
            </p>
          </div>
