      ...
      <div className="bg-[#FFF3E7] pl-5 md:pl-10 rounded-3xl flex justify-between flex-col md:flex-row items-center h-auto md:h-[18rem] gap-4 overflow-hidden relative">
        ...
        <div className="md:w-[50%] py-5 pr-5 md:py-0 md:pr-0 z-10">
          <h1 className="font-space-grotesk font-bold text-[20px] md:text-3xl lg:text-[32px] leading-[110%] tracking-[-0.36px] my-2 text-[#1F3A3A] md:text-[var(--allotease-teal)]">
            A Booking & Allocation System That Grows With You.
          </h1>
          <p className="font-source-sans text-[14px] md:text-base font-normal leading-[142.745%] tracking-[-0.28px] my-2 max-w-[500px] text-[#71727A] md:text-[var(--body-text)]">
            From listing spaces to managing events and ticketing— Allotease helps you list any stay, monetize every space, match your event to the right audience and earn with ease! List today. Scale tomorrow.
          </p>
