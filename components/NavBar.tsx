...
const NavBar = () => {
  ...
  return (
    <div className="flex items-center gap-1 justify-between px-4 py-2 sm:py-4 border">
        ...
        <div className="relative">
          ...
          <div className="hidden sm:flex items-center border border-[#8AAEA433] h-[40px] max-w-[300px] w-full rounded-full px-2 py-1 bg-[#F2F4F780] ">
            ...
            <input
              ...
              className="outline-none text-[#71727A]"
            />
          </div>

          {/* Toggleable input for mobile */}
            ...
            {showSearch ? (
              <div className="flex items-center border border-[#8AAEA433] rounded-full px-2 py-1 bg-[#F2F4F780]">
                ...
                <input
                  type="text"
                  placeholder="Search by address"
                  className="outline-none text-sm w-[120px] text-[#71727A]"
                  autoFocus
      ...
      {/* Right-side icons (only show if search is NOT active) */}
      {!showSearch && (
        <div className="flex items-center gap-3 md:gap-6 lg:gap-10">
          ...
          <div className="flex items-center gap-1">
            ...
            <div className="flex w-[10.5rem] items-center gap-1 truncate hidden lg:flex">
